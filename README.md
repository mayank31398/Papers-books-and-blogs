...
![image][paper]
1. [A deep reinforced model for abstractive summarization](https://openreview.net/forum?id=HkAClQgA-)  
...
![image][paper]
1. [A robust self-learning method for fully unsupervised cross-lingual mappings of word embeddings](https://aclanthology.org/P18-1073/)  
...
![image][paper]
1. [A stylometric inquiry into hyperpartisan and fake news](https://aclanthology.org/P18-1022/)  
...
![image][paper]
1. [Approximations by superpositions of sigmoidal functions](https://www.semanticscholar.org/paper/Approximation-by-superpositions-of-a-sigmoidal-Cybenko/8da1dda34ecc96263102181448c94ec7d645d085)  
*George Cybenko*  
![image][paper]
1. [Aspect based sentiment analysis with gated convolutional networks](https://aclanthology.org/P18-1234/)  
*Wei Xue, Tao Li*  
![image][paper]
1. [Attention is all you need](https://papers.nips.cc/paper/7181-attention-is-all-you-need)  
...
![image][paper]
1. [BART: denoising seuqence-to-sequence pre-training for natural language generation, translation and comprehension](https://arxiv.org/abs/1910.13461)  
*Mike Lewis, Yinhan Liu, Naman Goyal, Marjan Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov, Luke Zettlemoyer*  
![image][paper]
1. [Batch normalization: accelerating deep network training by reducing internal covariate shift](https://arxiv.org/abs/1502.03167)  
*Sergey Ioffe, Christian Szegedy*  
![image][paper]
1. [Behavioral cloning from observation](https://www.ijcai.org/proceedings/2018/687)  
...
*Yaser S. Abu-Mostafa*  
![image][paper]
1. [Constituency parsing with a self-attentive encoder](https://aclanthology.org/P18-1249/)  
*Nikita Kitaev, Dan Klein*  
![image][paper]
1. [Constraint based knowledge base distillation in end-to-end task oriented dialogs](https://aclanthology.org/2021.findings-acl.448/)  
*Dinesh Raghu, Atishya Jain, Mausam, Sachindra Joshi*  
![image][paper]
1. [Convolutional networks for graphs for learning molecular fingerprints](https://papers.nips.cc/paper/5954-convolutional-networks-on-graphs-for-learning-molecular-fingerprints)  
*David K. Duvenaud, Dougal Maclaurin, Jorge Iparraguirre, Rafael Bombarell, Timothy Hirzel, Alan Aspuru-Guzik, Ryan P. Adams*  
![image][paper]
1. [Convolutional neural network language models](https://aclanthology.info/papers/D16-1123/d16-1123)  
...
![image][paper]
1. [Deep learning and the information bottleneck principle](https://ieeexplore.ieee.org/document/7133169)  
...
![image][paper]
1. [Diffusion convolutional recurrent neural network: data-driven traffic forecasting](https://openreview.net/forum?id=SJiHXGWAZ)  
*Yaguang Li, Rose Yu, Cyrus Shahabi, Yan Liu*  
![image][paper]
1. [Discrete variational autoencoders](https://arxiv.org/abs/1609.02200?context=cs)  
*Jason Tyler Rolfe*  
![image][paper]
1. [Disentangling by factorising](https://arxiv.org/abs/1802.05983)  
*Hyunjik Kim, Andriy Mnih*  
![image][paper]
1. [Disentangling language and knowledge in task-oriented dialogs](https://aclanthology.org/N19-1126/)  
...
![image][paper]
1. [Enchancing the reliability of out-of-distribution image detection in neural networks](https://openreview.net/forum?id=H1VGkIxRZ)  
...
![image][paper]
1. [Fast abstractive summarization with reinforce-selected sentence rewriting](https://aclanthology.org/P18-1063/)  
...
![image][paper]
1. [Hierarchical neural story generation](https://aclanthology.org/P18-1082/)  
...
![image][paper]
1. [HyKnow: end-to-end task-oriented dialog modeling with hybrid knowledge management](https://aclanthology.org/2021.findings-acl.139/)  
...
*Phong Le, Ivan Titov*  
![image][paper]
1. [Improving language models by retrieving from trillions of tokens](https://www.deepmind.com/publications/improving-language-models-by-retrieving-from-trillions-of-tokens)  
*Sebastian Borgeaud, Arthur Mensch, Jordan Hoffmann, Trevor Cai, Eliza Rutherford, Katie Millican, George van den Driessche, Jean-Baptiste Lespiau, Bogdan Damoc, Aidan Clark, Diego de Las Casas, Aurelia Guy, Jacob Menick, Roman Ring, Tom Hennigan, Saffron Huang, Loren Maggiore, Chris Jones, Albin Cassirer, Andy Brock, Michela Paganini, Geoffrey Irving, Oriol Vinyals, Simon Osindero, Karen Simonyan, Jack W. Rae, Erich Elsen, Laurent Sifre*  
![image][paper]
1. [Improving language understanding by generative pre-training](https://openai.com/blog/language-unsupervised/)  
...
![image][paper]
1. [Know what you don't know: unanswerable questions for SQuAD](https://aclanthology.org/P18-2124/)  
...
![image][paper]
1. [Memory-efficient pipeline-parallel DNN training](https://proceedings.mlr.press/v139/narayanan21a.html)  
...
![image][paper]
1. [Mixed precision training](https://openreview.net/forum?id=r1gs9JgRZ)  
...
![image][paper]
1. [mixup: beyond empirical risk minimization](https://openreview.net/forum?id=r1Ddp1-Rb)  
...
![image][paper]
1. [MultiWOZ - A large-scale multi-domain Wizard-of-Oz dataset for task-oriented dialogue modelling](https://aclanthology.org/D18-1547/)  
...
![image][paper]
1. [NEMGAN: Noise Engineered Mode-Matching GAN](https://arxiv.org/abs/1811.03692v2)  
*Deepak Mishra, Prathosh A. P., Aravind J, Prashant Pandey, Santanu Chaudhury*  
![image][paper]
1. [Neural GPUs learn algorithms](https://arxiv.org/abs/1511.08228)  
*Łukasz Kaiser, Ilya Sutskever*  
![image][paper]
1. [Neural ordinary differential equations](http://papers.nips.cc/paper/7892-neural-ordinary-differential-equations)  
...
![image][paper]
1. [Open domain question answering over tables via dense retrieval](https://aclanthology.org/2021.naacl-main.43/)  
...
![image][paper]
1. [Outer product-based neural collaborative filtering](https://www.ijcai.org/proceedings/2018/0308)  
...
![image][paper]
1. [Personalizing dialogue agents: I have a dog, do you have pets too?](https://aclanthology.org/P18-1205/)  
...
*Thomas Hofmann*  
![image][paper]
1. [Progressive growing of GANs from improved quality, stability and variation](https://openreview.net/forum?id=Hk99zCeAb)  
*Tero Karras, Timo Aila, Samuli Laine, Jaakko Lehtinen*  
![image][paper]
1. [PullNet: open domain question answering with iterative retrieval on knowledge bases and text](http://aclanthology.lst.uni-saarland.de/D19-1242/)  
...
![image][paper]
1. [Regularizing and optimizing LSTM language models](https://openreview.net/forum?id=SyyGPP0TZ)  
...
![image][paper]
1. [Self-normalizing neural networks](https://papers.nips.cc/paper/6698-self-normalizing-neural-networks)  
...
![image][paper]
1. [Simple and effective multi-paragraph reading comprehension](https://aclanthology.org/P18-1078/)  
*Christopher Clark, Matt Gardner*  
![image][paper]
1. [Soft filter pruning for accelerating deep convolutional neural networks](https://www.ijcai.org/proceedings/2018/309)  
*Yang He, Guoliang Kang, Xuanyi Dong, Yanwei Fu, Yi Yang*  
![image][paper]
1. [Soloist few-shot task-oriented dialog with a single pre-trained auto-regressive model](https://arxiv.org/abs/2005.05298)  
...
![image][paper]
1. [Spatio-temporal graph convolutional networks: a deep learning framework for traffic forecasting](https://www.ijcai.org/proceedings/2018/505)  
*Bing Yu, Haoteng Yin, Zhanxing Zhu*  
![image][paper]
1. [Spectral normalization for generative adversarial networks](https://openreview.net/forum?id=B1QRgziT-)  
*Takeru Miyato, Toshiki Kataoka, Masanori Koyama, Yuichi Yoshida*  
![image][paper]
1. [Sticking the landing: simple, lower-variance gradient estimators for variational inference](https://papers.nips.cc/paper/7268-sticking-the-landing-simple-lower-variance-gradient-estimators-for-variational-inference)  
...
![image][paper]
1. [Style transfer from non-parallel text by cross-alignment](https://papers.nips.cc/paper/7259-style-transfer-from-non-parallel-text-by-cross-alignment)  
*Tianxiao Shen, Tao Lei, Regina Barzilay, Tommi Jaakkola*  
![image][paper]
1. [Subword regularization: improving neural network translation models with multiple subword candidates](https://aclanthology.org/P18-1007/)  
*Taku Kudo*  
![image][paper]
...
![image][paper]
1. [The best of both worlds: combining recent advances in neural machine translation](https://aclanthology.org/P18-1008/)  
...
![image][paper]
1. [Towards deep learning models resilient to adversarial attacks](https://openreview.net/forum?id=rJzIBfZAb)  
...
![image][paper]
1. [Universal language model fine-tuning for text classification](https://aclanthology.org/P18-1031/)  
...
![image][paper]
1. [Unsupervised representation learning by predicting image rotations](https://openreview.net/forum?id=S1v4N2l0-)  
...
![image][paper]
1. [ZeRO-Infinity: breaking the GPU memory wall for extreme scale deep learning](https://dl.acm.org/doi/abs/10.1145/3458817.3476205)  
...
![image][book]
1. [Distributed optimization and statistical learning via the alternating direction method of multipliers](https://web.stanford.edu/~boyd/papers/admm_distr_stats.html)  
