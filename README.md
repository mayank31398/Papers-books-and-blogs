This repository contains a list of the research papers, books and blogs that I have read and found interesting.
...
1. ![image][paper] [Integer optimization toolbox (minimizing polynomials over integer lattices using quantum annealing)](https://1qbit.com/our-thinking/white-papers/) - Pooya Ronagh
1. ![image][paper] [Limits on parallel speedup for classical Ising model solvers](https://www.dwavesys.com/resources/publications?type=white)
1. ![image][paper] [Partitioning optimization problems for hybrid classical/quantum execution](https://www.dwavesys.com/resources/publications?type=white) - Michael Booth, Steven P. Reinhardt, Aidan Roy
...
1. ![image][paper] [Programming with D-Wave: map coloring problem](https://www.dwavesys.com/resources/publications?type=white) - E. D. Dahl
1. ![image][paper] [Quantum performance evaluation: a short reading list](https://www.dwavesys.com/resources/publications?type=white)
